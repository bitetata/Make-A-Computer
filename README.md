本书内容主要是帮助读者使用Logisim软件从无到有的制作一台计算机，同时使用最简单的语言和动画向读者阐述计算机的工作原理。书中所使用的项目文件可在[Github](https://github.com/bitetata/Make-A-Computer)下载。

* [Github項目地址](https://github.com/bitetata/Make-A-Computer)
* [Gitee阅读（国内推荐）](https://crystalgame.gitee.io/make-a-computer)
* [Github Pages阅读](https://bitetata.github.io/Make-A-Computer/)
