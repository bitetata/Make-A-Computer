...
romAddrBits = 8		#ROM地址的位数
romDataBits = 8		#ROM数据的位数
...
def genOneCode(addr=0, data=0, enData=0, enLedIn=0, enAddOut=0, enAddIn1=0, enAddIn2=0, enMemOut=0, enMemAddrIn=0, enMemDataIn=0, enCmpIn2=0, enCmpIn1=0, enCmpOut=0, enKeyIn=0):
	...
	addr: ROM地址(0-7 bit)
	data: ROM数据(8-15 bit)
	enData: 控制“ROM数据”是否链接总线(16 bit)
	enLedIn: 控制“LED输入”是否链接总线(17 bit)
	enAddOut: 控制“加法器输出”是否链接总线(18 bit)
	enAddIn1: 控制“加法器输入1”是否链接总线(19 bit)
	enAddIn2: 控制“加法器输入2”是否链接总线(20 bit)
	enMemOut: 控制“内存输出”是否链接总线(21 bit)
	enMemAddrIn: 控制“内存地址输入”是否链接总线(22 bit)
	enMemDataIn: 控制“内存数据输入”是否链接总线(23 bit)
	enCmpIn2: 控制“比较器输入2”是否链接总线(24 bit)
	enCmpIn1: 控制“比较器输入1”是否链接总线(25 bit)
	enCmpOut: 控制“比较器输出”是否链接总线(26 bit)
	enKeyIn: 控制“按键输入”是否链接总线(27 bit)
	"""
